...
version = "1.0.3-1"
source = {
   url = "https://github.com/GrapeAppleFruit/the-night-shift-sdk/archive/v1.0.3.zip",
   dir = "the-night-shift-sdk-1.0.3"
}
description = {
...
build = {
   type = "module",
   modules = {
      ["lobby_server_sdk"] = "src/init.lua",
      ["lobby_server_sdk.utils"] = "src/utils.lua"
   }
}