...
version = "2.0.5-0"
source = {
   url = "https://gitlab.com/megalithic-llc/stuart-ml/-/archive/2.0.5-0/stuart-ml-2.0.5-0.tar.gz",
   dir = "stuart-ml-2.0.5-0"
}
description = {
   ...
   homepage = "https://gitlab.com/megalithic-llc/stuart-ml",
