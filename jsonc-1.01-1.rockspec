...
description = {
   ...
   detailed = [[
      ...
      a static normalizer for duplicate keys, and a deep query system via load() that polymorphically
      accepts complex multidimensional paths (e.g., self.tags or self.value).
   ]],
