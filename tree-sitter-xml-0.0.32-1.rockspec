local git_ref = 'cd1316e476ec40da6ce1fb5749c9d7e6b4f1090c'
local modrev = '0.0.32'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-dtd == 0.0.31' } 
...
source = {
  ...
  dir = 'tree-sitter-xml-' .. 'cd1316e476ec40da6ce1fb5749c9d7e6b4f1090c',
}
