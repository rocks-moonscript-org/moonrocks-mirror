...
version = "1.0.7-1"
source = {
   url = "https://github.com/GrapeAppleFruit/the-night-shift-sdk/archive/v1.0.7.zip",
   dir = "the-night-shift-sdk-1.0.7"
}
description = {
...
build = {
   type = "builtin",
   modules = {
      ["lobby_server_sdk"] = "init.lua",
      ["lobby_server_sdk.utils"] = "utils.lua"
   }
}