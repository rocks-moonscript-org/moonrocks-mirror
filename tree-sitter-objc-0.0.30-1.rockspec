local git_ref = '18802acf31d0b5c1c1d50bdbc9eb0e1636cab9ed'
local modrev = '0.0.30'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-c == 0.0.35' } 
...
source = {
  ...
  dir = 'tree-sitter-objc-' .. '18802acf31d0b5c1c1d50bdbc9eb0e1636cab9ed',
}
