local git_ref = '5021edde6d0ea75aedc313e75cca2ac5aa064d41'
local modrev = '0.0.37'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-php_only == 0.0.38' } 
...
source = {
  ...
  dir = 'tree-sitter-php-' .. '5021edde6d0ea75aedc313e75cca2ac5aa064d41',
}
