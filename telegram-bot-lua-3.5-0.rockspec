...
version = "3.5-0"
source = {
    url = "https://github.com/wrxck/telegram-bot-lua/archive/refs/tags/v3.5.tar.gz",
    dir = "telegram-bot-lua-3.5"
}
description = {
    summary = "A feature-filled Telegram bot API library",
    detailed = "A feature-filled Telegram bot API library written in Lua, with Bot API 9.6 support.",
