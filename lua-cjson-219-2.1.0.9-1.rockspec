package = "lua-cjson-219"
version = "2.1.0.9-1"

source = {
    url = "git+https://github.com/Mehgugs/lua-cjson",
    tag = "2.1.0.9",
}
...
description = {
    ...
    detailed = [[
        This is a pinned rock to 2.1.0.9-1 of openresty/lua-cjson,
        This rock exists because lua-cjson has not had releases published for some time.
