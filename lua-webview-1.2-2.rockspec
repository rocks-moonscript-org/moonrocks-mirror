...
description = {
  ...
  detailed = [[
    ...
    This module is a binding of the tiny cross-platform webview-c library.
		...
		Download the lua 64 bits dynamic libraries built with mingw64 from https://sourceforge.net/projects/luabinaries/files/5.3.5/Windows%20Libraries/Dynamic/
		Open a command prompt with git, msys2 and mingw64 in the path
		luarocks --lua-dir .../lua-5.3.5 MAKE=make CC=gcc LD=gcc install lua-webview
