local git_ref = '9e3ec9848f28d26845ba300fd73c740459b83e9b'
local modrev = '0.0.12'
local specrev = '1'
...
rockspec_format = '3.0'
package = 'tree-sitter-terraform'
version = modrev ..'-'.. specrev

description = {
  summary = 'tree-sitter parser for terraform',
  labels = { 'neovim', 'tree-sitter' } ,
  homepage = 'https://github.com/MichaHoffmann/tree-sitter-hcl',
  license = 'UNKNOWN'
}

dependencies = { 'lua >= 5.1', 'tree-sitter-hcl == 0.0.12' } 
...
source = {
  ...
  dir = 'tree-sitter-hcl-' .. '9e3ec9848f28d26845ba300fd73c740459b83e9b',
}
