local git_ref = 'f3a19ab3217a6e838870fc7142fa492d1fd7a7c9'
local modrev = '0.0.38'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-php_only == 0.0.39' } 
...
source = {
  ...
  dir = 'tree-sitter-php-' .. 'f3a19ab3217a6e838870fc7142fa492d1fd7a7c9',
}
