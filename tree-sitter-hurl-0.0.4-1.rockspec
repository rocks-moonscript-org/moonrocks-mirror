local git_ref = 'fba6ed8db3a009b9e7d656511931b181a3ee5b08'
local modrev = '0.0.4'
local specrev = '1'

local repo_url = 'https://github.com/pfeiferj/tree-sitter-hurl'

rockspec_format = '3.0'
package = 'tree-sitter-hurl'
version = modrev ..'-'.. specrev

description = {
  summary = 'tree-sitter parser for hurl',
  labels = { 'neovim', 'tree-sitter' } ,
  homepage = 'https://github.com/pfeiferj/tree-sitter-hurl',
  license = 'UNKNOWN'
}
...
source = {
  ...
  dir = 'tree-sitter-hurl-' .. 'fba6ed8db3a009b9e7d656511931b181a3ee5b08',
}
