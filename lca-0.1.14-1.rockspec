...
version = "0.1.14-1"
source = {
	url = "https://github.com/forkfork/lca/archive/refs/tags/v0.1.14.tar.gz",
	dir = "lca-0.1.14",
}
description = {
...
build = {
	...
	install = {
		bin = {
			...
			["lca-context-stats"] = "scripts/context_stats.lua",
			["lca-cache-probe"] = "scripts/codex_cache_probe.lua",
			["lca-prompt-diff"] = "scripts/prompt_diff.lua",
