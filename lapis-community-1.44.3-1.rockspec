...
source = {
  url = "git+https://github.com/leafo/lapis-community.git",
  branch = "v1.44.3"
}
...
build = {
  ...
  modules = {
    ...
    ["community.models.virtual.user_users"] = "community/models/virtual/user_users.lua",
    ["community.models.votes"] = "community/models/votes.lua",
    ["community.models.warnings"] = "community/models/warnings.lua",
