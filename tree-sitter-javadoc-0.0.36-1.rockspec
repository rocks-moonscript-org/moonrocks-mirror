local git_ref = '60bfacbc38a4d7902915ddf5338d0035274226d5'
local modrev = '0.0.36'
local specrev = '1'

local repo_url = 'https://github.com/rmuir/tree-sitter-javadoc'

rockspec_format = '3.0'
package = 'tree-sitter-javadoc'
version = modrev ..'-'.. specrev

description = {
  summary = 'tree-sitter parser for javadoc',
