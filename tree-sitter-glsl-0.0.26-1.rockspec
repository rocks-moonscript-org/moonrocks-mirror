local git_ref = '66aec57f7119c7e8e40665b723cd7af5594f15ee'
local modrev = '0.0.26'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-c == 0.0.26' } 
...
source = {
  ...
  dir = 'tree-sitter-glsl-' .. '66aec57f7119c7e8e40665b723cd7af5594f15ee',
}
