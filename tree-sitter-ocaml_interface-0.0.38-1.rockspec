local git_ref = '103dec4e70c1041c56a3f8ed91435084244a00cd'
local modrev = '0.0.38'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-ocaml == 0.0.37' } 
...
source = {
  ...
  dir = 'tree-sitter-ocaml-' .. '103dec4e70c1041c56a3f8ed91435084244a00cd',
}
