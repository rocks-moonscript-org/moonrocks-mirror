...
version = "2.0.0-2"
source = {
    url = "git://github.com/ricristian/kong-openid-v3",
    tag = "2.0.0",
    dir = "kong-openid-v3"
}
description = {
    ...
    detailed = [[
        kong-openid-v3 is a Kong plugin for implementing the OpenID Connect Relying Party.
    ...
    homepage = "https://github.com/ricristian/kong-openid-v3",
    license = "Apache 2.0"
}
dependencies = {
