...
dependencies = { 'lua >= 5.1', 'nui.nvim', 'pathlib.nvim', 'coop.nvim', 'plenary.nvim', 'tree-sitter-xml', 'tree-sitter-markdown', 'tree-sitter-html' } 

test_dependencies = { }

source = {
  url = repo_url .. '/archive/' .. git_ref .. '.zip',
  dir = 'feed.nvim-' .. '1.16.1',
}
