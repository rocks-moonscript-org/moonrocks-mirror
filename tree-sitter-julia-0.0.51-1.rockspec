local git_ref = '8454f266717232525ed03c7b09164b0404a03150'
local modrev = '0.0.51'
local specrev = '1'

local repo_url = 'https://github.com/tree-sitter-grammars/tree-sitter-julia'
...
description = {
  ...
  homepage = 'https://github.com/tree-sitter-grammars/tree-sitter-julia',
  license = 'UNKNOWN'
}
