...
build = {
  ...
  modules = {
    ...
    ["privata._annotations"] = "lua/privata/_annotations.lua",
    ...
    ["privata._interfaces"] = "lua/privata/_interfaces.lua",
    ...
    ["privata._patterns"] = "lua/privata/_patterns.lua",
    ...
    ["privata._rockspec"] = "lua/privata/_rockspec.lua",
    ...
    ["privata._tach"] = "lua/privata/_tach.lua",
  },
  install = {
    bin = {
