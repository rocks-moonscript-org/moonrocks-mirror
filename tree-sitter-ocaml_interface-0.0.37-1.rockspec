local git_ref = '57644edfbba0edb38ac17dba2add4c243fa3539b'
local modrev = '0.0.37'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-ocaml == 0.0.36' } 
...
source = {
  ...
  dir = 'tree-sitter-ocaml-' .. '57644edfbba0edb38ac17dba2add4c243fa3539b',
}
