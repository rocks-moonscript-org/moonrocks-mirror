local git_ref = '7780d05ba0b2d78882cbbda03fcadba41d1ee17f'
local modrev = '0.0.36'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-php_only == 0.0.37' } 
...
source = {
  ...
  dir = 'tree-sitter-php-' .. '7780d05ba0b2d78882cbbda03fcadba41d1ee17f',
}
