...
local repo_url = 'https://github.com/bytecodealliance/tree-sitter-wit'
...
description = {
  summary = 'tree-sitter parser for wit',
  labels = { 'neovim', 'tree-sitter' } ,
  homepage = 'https://github.com/bytecodealliance/tree-sitter-wit',
  license = 'UNKNOWN'
}
