local git_ref = 'f41b4f66a42100be405f96bdc4ebc4a61095d3e8'
local modrev = '0.0.35'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-c == 0.0.34' } 
...
source = {
  ...
  dir = 'tree-sitter-cpp-' .. 'f41b4f66a42100be405f96bdc4ebc4a61095d3e8',
}
