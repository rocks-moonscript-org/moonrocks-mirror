local git_ref = '181a81b8f23a2d593e7ab4259981f50122909fda'
local modrev = '0.0.31'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-c == 0.0.39' } 
...
source = {
  ...
  dir = 'tree-sitter-objc-' .. '181a81b8f23a2d593e7ab4259981f50122909fda',
}
