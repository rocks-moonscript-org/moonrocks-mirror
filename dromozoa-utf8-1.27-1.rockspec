...
version = "1.27-1"
source = {
  url = "https://github.com/dromozoa/dromozoa-utf8/archive/v1.27.tar.gz";
  file = "dromozoa-utf8-1.27.tar.gz";
}
description = {
...
build = {
  ...
  modules = {
    ...
    ["dromozoa.ucd.east_asian_width_ambiguous_full"] = "dromozoa/ucd/east_asian_width_ambiguous_full.lua";
    ["dromozoa.ucd.east_asian_width_ambiguous_half"] = "dromozoa/ucd/east_asian_width_ambiguous_half.lua";
