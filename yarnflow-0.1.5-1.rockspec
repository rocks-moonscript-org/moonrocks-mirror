...
description = {
	...
	detailed = [[
		YarnFlow is an efficient compiler that translates Yarn Spinner scripts into Lua code, allowing you to seamlessly integrate interactive story elements from Yarn Spinner into Lua-based projects. Whether you're developing a game, an interactive app, or any Lua-powered project, YarnFlow simplifies the process of leveraging Yarn Spinner鈥檚 intuitive story-based scripting language with the power and flexibility of Lua.
	]],
