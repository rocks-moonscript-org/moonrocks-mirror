local git_ref = '0c534d56bb04778d0a3510bed5e720d1fe15cb76'
local modrev = '0.0.4'
local specrev = '1'

local repo_url = 'https://github.com/ajdelcimmuto/tree-sitter-brightscript'

rockspec_format = '3.0'
package = 'tree-sitter-brightscript'
version = modrev ..'-'.. specrev

description = {
  summary = 'tree-sitter parser for brightscript',
  labels = { 'neovim', 'tree-sitter' } ,
  homepage = 'https://github.com/ajdelcimmuto/tree-sitter-brightscript',
  license = 'UNKNOWN'
}
