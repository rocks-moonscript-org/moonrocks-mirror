local git_ref = '5aa8b258cc81a5ac1b76faf7dfc1a11dad300830'
local modrev = '0.0.14'
local specrev = '1'

local repo_url = 'https://github.com/georgeharker/tree-sitter-zsh'

rockspec_format = '3.0'
package = 'tree-sitter-zsh'
version = modrev ..'-'.. specrev

description = {
  summary = 'tree-sitter parser for zsh',
