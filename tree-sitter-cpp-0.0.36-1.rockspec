local git_ref = 'b70136fc6b36a5b85f2da3af2ccafc9e8020b3ed'
local modrev = '0.0.36'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-c == 0.0.37' } 
...
source = {
  ...
  dir = 'tree-sitter-cpp-' .. 'b70136fc6b36a5b85f2da3af2ccafc9e8020b3ed',
}
