...
description = {
   ...
   detailed = [[
      ...
      luarocks install --server=https://github.com/smbape/lua-opencv/releases/download/v0.0.5 opencv_lua-contrib

      Or to specify the target lua version with one of the following commands
      luarocks install --server=https://github.com/smbape/lua-opencv/releases/download/v0.0.5 opencv_lua-contrib 4.10.0luajit2.1
      luarocks install --server=https://github.com/smbape/lua-opencv/releases/download/v0.0.5 opencv_lua-contrib 4.10.0lua5.4
      luarocks install --server=https://github.com/smbape/lua-opencv/releases/download/v0.0.5 opencv_lua-contrib 4.10.0lua5.3
      luarocks install --server=https://github.com/smbape/lua-opencv/releases/download/v0.0.5 opencv_lua-contrib 4.10.0lua5.2
      luarocks install --server=https://github.com/smbape/lua-opencv/releases/download/v0.0.5 opencv_lua-contrib 4.10.0lua5.1
      ...
      luarocks install --server=https://github.com/smbape/lua-opencv/releases/download/v0.0.5 opencv_lua-contrib 4.10.0
   ]],
