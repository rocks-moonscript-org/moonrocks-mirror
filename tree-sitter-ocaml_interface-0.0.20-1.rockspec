local git_ref = '45ddc92d18fa11b2ca1a18cd94de4e63feea0806'
local modrev = '0.0.20'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-ocaml == 0.0.20' } 
...
source = {
  ...
  dir = 'tree-sitter-ocaml-' .. '45ddc92d18fa11b2ca1a18cd94de4e63feea0806',
}
