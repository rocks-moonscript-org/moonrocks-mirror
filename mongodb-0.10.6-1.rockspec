...
description = {
  ...
  detailed = [[
    ...
    libmongoc. Version 0.10.6 completes standardized logging with topology,
    heartbeat, connection-pool, connection, and checkout lifecycle messages.
  ]],
...
build = {
  ...
  modules = {
    ...
    ["mongodb.operation_id"] = "src/mongodb/operation_id.lua",
