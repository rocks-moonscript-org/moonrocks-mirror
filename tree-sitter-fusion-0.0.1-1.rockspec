local git_ref = '19db2f47ba4c3a0f6238d4ae0e2abfca16e61dd6'
local modrev = '0.0.1'
local specrev = '1'

local repo_url = 'https://gitlab.com/jirgn/tree-sitter-fusion'

rockspec_format = '3.0'
package = 'tree-sitter-fusion'
version = modrev ..'-'.. specrev

description = {
  summary = 'tree-sitter parser for fusion',
  labels = { 'neovim', 'tree-sitter' } ,
  homepage = 'https://gitlab.com/jirgn/tree-sitter-fusion',
  license = 'UNKNOWN'
}
...
source = {
  ...
  dir = 'tree-sitter-fusion-' .. '19db2f47ba4c3a0f6238d4ae0e2abfca16e61dd6',
}
