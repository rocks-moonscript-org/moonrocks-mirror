local git_ref = '2bce5a6588ad6d53ffe5effaf9708682f0fbfc9b'
local modrev = '0.0.33'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-php_only == 0.0.33' } 
...
source = {
  ...
  dir = 'tree-sitter-php-' .. '2bce5a6588ad6d53ffe5effaf9708682f0fbfc9b',
}
