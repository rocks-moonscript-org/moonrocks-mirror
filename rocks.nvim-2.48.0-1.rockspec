local git_ref = 'v2.48.0'
local modrev = '2.48.0'
local specrev = '1'

local repo_url = 'https://github.com/lumen-oss/rocks.nvim'
...
dependencies = { 'lua == 5.1', 'luarocks >= 3.11.1, < 4.0.0', 'toml-edit >= 0.6.1', 'fidget.nvim >= 1.1.0', 'fzy', 'nvim-nio', 'rtp.nvim' } 

test_dependencies = { }

source = {
  url = repo_url .. '/archive/' .. git_ref .. '.zip',
  dir = 'rocks.nvim-' .. '2.48.0',
}
