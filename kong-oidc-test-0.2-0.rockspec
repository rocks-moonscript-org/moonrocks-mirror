...
version = "0.2-0"
source = {
    url = "git://github.com/grizzlyblitz/kong-oidc-test",
    tag = "v0.2",
    dir = "kong-oidc-test"
}
description = {
    ...
    detailed = [[
        This is a fork of kong-oidc.

        kong-oidc-test is a Kong plugin for implementing the OpenID Connect Relying Party.
