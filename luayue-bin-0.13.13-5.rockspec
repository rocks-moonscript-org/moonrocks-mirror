...
build = {
   ...
   platforms = {
      ...
      mingw32 = {
         build_command = "cmd /c \"'$(LUA)' \"install.lua build win32 \"LUA=$(LUA)\" \"CURL=$(CURL)\" \"YUE_VERSION=latest\" \"INST_LIBDIR=$(LIBDIR)\" \"WGET=$(WGET)\" \"TAR=$(TAR)\" \"UNZIP=$(UNZIP)\" ",
         install_command = "cmd /c \"'$(LUA)' \"install.lua install win32 \"LUA=$(LUA)\" \"CURL=$(CURL)\" \"YUE_VERSION=latest\" \"INST_LIBDIR=$(LIBDIR)\" \"WGET=$(WGET)\" \"TAR=$(TAR)\" \"UNZIP=$(UNZIP)\" "
      },
      unix = {
