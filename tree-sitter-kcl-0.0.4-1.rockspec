local git_ref = '6a5cc921928660cd6756cd6e0d636d9e24ea348e'
local modrev = '0.0.4'
local specrev = '1'

local repo_url = 'https://github.com/kcl-lang/tree-sitter-kcl'

rockspec_format = '3.0'
package = 'tree-sitter-kcl'
version = modrev ..'-'.. specrev

description = {
  summary = 'tree-sitter parser for kcl',
  labels = { 'neovim', 'tree-sitter' } ,
  homepage = 'https://github.com/kcl-lang/tree-sitter-kcl',
  license = 'UNKNOWN'
}
