...
source = {
    url = "https://github.com/pessoa736/PudimBasicsOpenGL/archive/refs/tags/v1.0.0-18.tar.gz",
    tag = "v1.0.0-18",
    dir = "PudimBasicsOpenGL-1.0.0-18"
}
...
description = {
    ...
    detailed = [[
        ...
        Changes in 1.0.0-18:
        - docs: add AI agent instruction guide (`docs/forAgents/agent-guide.md`)
    ]],
