...
description = {
  summary = 'Use luagit2 to realize a :Git in neovim',
  detailed = '',
  labels = { "neovim", "git2" },
...
dependencies = { 'lua >= 5.1', 'mega.argparse', 'vim', 'luabitop', 'yaml', 'lua-git2-temp' }

test_dependencies = {}

source = {
  url = repo_url .. '/archive/' .. git_ref .. '.zip',
  dir = 'git2.nvim-' .. '0.0.15',
}
