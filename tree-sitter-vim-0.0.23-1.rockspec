local git_ref = 'f3cd62d8bd043ef20507e84bb6b4b53731ccf3a7'
local modrev = '0.0.23'
local specrev = '1'

local repo_url = 'https://github.com/tree-sitter-grammars/tree-sitter-vim'
...
source = {
  ...
  dir = 'tree-sitter-vim-' .. 'f3cd62d8bd043ef20507e84bb6b4b53731ccf3a7',
}
