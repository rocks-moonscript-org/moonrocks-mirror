local git_ref = 'db52ba3f7f33c9949bba115a813d7c30a359cd87'
local modrev = '0.0.41'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-ocaml == 0.0.40' } 
...
source = {
  ...
  dir = 'tree-sitter-ocaml-' .. 'db52ba3f7f33c9949bba115a813d7c30a359cd87',
}
