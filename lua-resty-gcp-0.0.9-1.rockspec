...
build = {
  type = "builtin",
  modules = {
-- NOTE: This part of the rockspec file is auto-generated. Use the update script
-- (./scripts/update-rockspec) to add/remove files.
--
--START-MARKER--
    ...
    ["resty.gcp.api.analyticshub_v1"] = "src/resty/gcp/api/analyticshub_v1.lua",
    ...
    ["resty.gcp.api.connectors_v2"] = "src/resty/gcp/api/connectors_v2.lua",
    ...
    ["resty.gcp.api.contentwarehouse_v1"] = "src/resty/gcp/api/contentwarehouse_v1.lua",
    ...
    ["resty.gcp.api.displayvideo_v2"] = "src/resty/gcp/api/displayvideo_v2.lua",
    ...
    ["resty.gcp.api.drivelabels_v2"] = "src/resty/gcp/api/drivelabels_v2.lua",
    ...
    ["resty.gcp.api.identitytoolkit_v1"] = "src/resty/gcp/api/identitytoolkit_v1.lua",
    ["resty.gcp.api.identitytoolkit_v2"] = "src/resty/gcp/api/identitytoolkit_v2.lua",
    ...
    ["resty.gcp.api.metastore_v1"] = "src/resty/gcp/api/metastore_v1.lua",
    ...
    ["resty.gcp.api.tpu_v2"] = "src/resty/gcp/api/tpu_v2.lua",
    ...
    ["resty.gcp.api.travelimpactmodel_v1"] = "src/resty/gcp/api/travelimpactmodel_v1.lua",
    ...
    ["resty.gcp.api.workloadmanager_v1"] = "src/resty/gcp/api/workloadmanager_v1.lua",
