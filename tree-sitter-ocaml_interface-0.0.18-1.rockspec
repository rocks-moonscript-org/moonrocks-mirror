local git_ref = '19639e5dcd68a34f7704ea2e39a5730308c2234c'
local modrev = '0.0.18'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-ocaml == 0.0.18' } 
...
source = {
  ...
  dir = 'tree-sitter-ocaml-' .. '19639e5dcd68a34f7704ea2e39a5730308c2234c',
}
