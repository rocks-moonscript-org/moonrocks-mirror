...
build = {
   ...
   modules = {
      ...
      ["kong.plugins.virtual-endpoints.typedefs.config"] = "kong/plugins/virtual-endpoints/typedefs/config.lua",
      ["kong.plugins.virtual-endpoints.typedefs.request"] = "kong/plugins/virtual-endpoints/typedefs/request.lua",
      ["kong.plugins.virtual-endpoints.typedefs.response"] = "kong/plugins/virtual-endpoints/typedefs/response.lua"
   }
}
