local git_ref = 'ca14f24ad00af1c3d3e2e563f02b08ae967da1c8'
local modrev = '0.0.33'
local specrev = '1'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-c == 0.0.33' } 
...
source = {
  ...
  dir = 'tree-sitter-cpp-' .. 'ca14f24ad00af1c3d3e2e563f02b08ae967da1c8',
}
