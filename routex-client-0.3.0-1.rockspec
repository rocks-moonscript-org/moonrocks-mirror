...
build = {
  ...
  modules = {
    ...
    ["routex-client.client"] = "routex-client/client.lua",
    ["routex-client.core"] = "routex-client/core.lua",
    ...
    ["routex-client.refresh"] = "routex-client/refresh.lua",
    ["routex-client.response"] = "routex-client/response.lua",
