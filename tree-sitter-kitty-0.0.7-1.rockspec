local git_ref = 'fa6ab3fd32d890a0217495c96b35761e6d2dcb5b'
local modrev = '0.0.7'
local specrev = '1'

local repo_url = 'https://github.com/OXY2DEV/tree-sitter-kitty'

rockspec_format = '3.0'
package = 'tree-sitter-kitty'
version = modrev ..'-'.. specrev

description = {
  summary = 'tree-sitter parser for kitty',
  labels = { 'neovim', 'tree-sitter' } ,
  homepage = 'https://github.com/OXY2DEV/tree-sitter-kitty',
  license = 'UNKNOWN'
}
