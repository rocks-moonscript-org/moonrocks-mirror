local git_ref = 'ce8011a414fdf8091f4e4071752efc376f4afb08'
local modrev = '0.0.34'
local specrev = '1'

local repo_url = 'https://github.com/tree-sitter-grammars/tree-sitter-vue'
...
dependencies = { 'lua >= 5.1', 'tree-sitter-html_tags == 0.0.30' } 
