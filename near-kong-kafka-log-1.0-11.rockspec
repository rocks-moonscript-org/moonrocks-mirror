package = "near-kong-kafka-log"
version = "1.0-11"
source = {
   url = "git+https://github.com/near/kong-kafka-log.git"
}
description = {
   ...
   detailed = [[
    ...
    Please see here for more info: https://github.com/near/kong-kafka-log
   ]],
   homepage = "https://github.com/near/kong-kafka-log",
   license = "Apache 2.0"
}
dependencies = {}
build = {
